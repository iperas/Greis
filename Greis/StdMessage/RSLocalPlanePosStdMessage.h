...
namespace Greis
{
    class RSLocalPlanePosStdMessage : public StdMessage
    {
    public:
        SMART_PTR_T(RSLocalPlanePosStdMessage);

        RSLocalPlanePosStdMessage(const char* p_message, int p_length);
        RSLocalPlanePosStdMessage(const std::string& p_id, int p_size);

        virtual std::string ToString() const;
        virtual std::string Id() const { return _id; }
        virtual EMessageId::Type IdNumber() const { return EMessageId::RSLocalPlanePos; }

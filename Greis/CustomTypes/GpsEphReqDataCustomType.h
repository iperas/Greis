...
namespace Greis
{
    class GpsEphReqDataCustomType : public CustomType
    {
    public:
        SMART_PTR_T(GpsEphReqDataCustomType);

        GpsEphReqDataCustomType(const char* p_message, int p_length);
        GpsEphReqDataCustomType(int p_size);
        
        virtual ECustomTypeId::Type IdNumber() const { return ECustomTypeId::GpsEphReqData; }
